...
type streamable interface {
	ErnieBotResponse | ErnieBotTurboResponse | Bloomz7b1Response | LlamaChatResponse | BaiduChatResponse | ErnieCustomPluginResponse | ErnieBot4Response | CompletionResponse
}
